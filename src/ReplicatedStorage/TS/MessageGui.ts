...
class MessageGuiC
{
    ...
    private ShowMessageWait( message: MessageI )
    {
        ...
        else
        {
            ...
            newMessage.FindFirstChild<Frame>('Main')!.FindFirstChild<TextLabel>('Message')!.Text = message.messageS
            ...
            if( message.answer2S )
            {
                ...
                // newMessage.Main.Done.MouseButton1Click.Connect( function()
                //     result = message.answer1S
                // })
            }
